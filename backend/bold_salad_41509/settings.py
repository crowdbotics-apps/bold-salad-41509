"""
Django settings for bold_salad_41509 project.
...
ROOT_URLCONF = 'bold_salad_41509.urls'
...
WSGI_APPLICATION = 'bold_salad_41509.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bold_salad_41509 API",
    "DESCRIPTION": "API documentation for bold_salad_41509 App",
    "VERSION": "v1",
}
